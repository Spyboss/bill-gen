...
import { DownloadOutlined, PrinterOutlined, ReloadOutlined, TrendingUpOutlined, TrendingDownOutlined, WarningOutlined, CheckCircleOutlined } from '@ant-design/icons';
  ...
  const analyticsColumns = analytics?.modelPerformance ? [
    ...
    },
    {
      ...
      render: (health) => {
        ...
        const icon = health === 'Fast Moving' ? <TrendingUpOutlined /> :
                    health === 'Slow Moving' ? <TrendingDownOutlined /> : null;
